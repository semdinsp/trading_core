defmodule TradingCore.Signal.Spec do
  ...
  @base_kinds ~w(plain momentum volume vwap donchian rolling_volume spread book_imbalance two_scale_rv quoted_spread effective_spread signed_volume ofi kyle_lambda)a
